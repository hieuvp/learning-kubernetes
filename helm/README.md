...
- **Release**:
  a specific instance of a **Chart** which has been deployed to the Kubernetes cluster using **Helm**.

- **Repository**:
  a place where published **Charts** reside and can be shared with others.
